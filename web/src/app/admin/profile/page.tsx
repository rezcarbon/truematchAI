  ...
  return (
    <div className="space-y-6">
      <PageHeader
        ...
        subtitle="Manage your account details and system access."
        icon="User"
      />
        ...
        <Card className="mt-6">
          ...
          <CardContent className="space-y-4">
            ...
            <div className="pt-3 border-t space-y-2">
              <p className="text-xs text-muted-foreground">As an administrator, you have full access to:</p>
              <ul className="text-xs text-muted-foreground space-y-1 list-disc list-inside">
                <li>Platform configuration and settings</li>
                <li>All user accounts and roles</li>
                <li>Job positions and candidate management</li>
                <li>CV Analysis and JD Simulation tools</li>
                <li>System audit logs and activity monitoring</li>
              </ul>
            </div>
          </CardContent>
        </Card>
