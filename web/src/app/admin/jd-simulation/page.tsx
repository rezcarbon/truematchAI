...
export default function AdminJDSimulationPage() {
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        ...
        subtitle="Analyze a job posting to identify capability gaps, requirement creep, and optimization opportunities"
        icon="Zap"
      />
